package tk.ap17.app.autoconcept.models.exempleLaurent;
...
public class ConnectionMySQL {
	...
	public void connect() throws SQLException {
		...
		/*
		 * Autre utilisation possible: String dBurl =
		 * "jdbc:mysql://"+host+"/demojava" +
		 * "?user="+user+"&password="+password; connection =
